...
public class JavaCalendarTest {
    ...
    @Test
    public void Can_minus_seconds() {

        // Given
        final int seconds = somePositiveInteger();

        // When
        final Calendar actual = javaCalendar.minusSeconds(seconds);

        // Then
        verify(calendar).add(SECOND, -seconds);
        assertThat(actual, is(javaCalendar));
    }

    @Test
    public void Can_add_seconds() {

        // Given
        final int seconds = somePositiveInteger();

        // When
        final Calendar actual = javaCalendar.addSeconds(seconds);
    ...
    @Test
    public void Can_minus_minutes() {

        // Given
        final int minutes = somePositiveInteger();

        // When
        final Calendar actual = javaCalendar.minusMinutes(minutes);

        // Then
        verify(calendar).add(MINUTE, -minutes);
        assertThat(actual, is(javaCalendar));
    }
    ...
    public void Can_add_minutes() {
        ...
        // When
        final Calendar actual = javaCalendar.addMinutes(minutes);
